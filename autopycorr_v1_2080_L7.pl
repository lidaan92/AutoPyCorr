...
##################################################### log file ##################################################
print "Operations will be logged in /Landsat7/logs 'auto_pycorr.log' +---------------------------------]|>\n";

#open new file and write > (>> would open and append) $=variable
open my $fh, ">", "/Volumes/RAID/Landsat7/logs/auto_pycorr.log" or die "FATAL: Could not open log!: $!\n";
print $fh "=======================================================================================\n";
...
print $fh "_____________________________________ end of run ______________________________________\n";   
close $fh;
